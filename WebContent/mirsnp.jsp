...
<div>
<s:form id="Form3_1" name="Form3_1" action="mirsnp2" method="post" theme="simple">
...
<input type="submit" name="Submit" value="Search selected miRNA(s)"/>
<input name="mirsnp2" type="checkbox" id="chkall"  onclick="CheckAll(this.form)" />
      select all
...
<tbody>
<s:iterator value="#request.mirsnp_List">
<tr>

<td><input type="checkbox" name="mirsnp2" value="<s:property value="SNP_ID"></s:property>"/></td>
