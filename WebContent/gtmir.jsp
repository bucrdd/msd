...
<div id="apDiv7" >
 ...
 <s:form id="Form3_1" name="Form3_1" action="gtmir2" method="post" theme="simple">
...
<input type="submit" name="Submit" value="Search selected miRNA(s)"></input>
<input name="gtmir2" type="checkbox" id="chkall"  onclick="CheckAll(this.form)" ></input>
      select all
...
<s:iterator value="#request.gtmir_List" status="sz">

<tr>
<td><input type="checkbox" name="gtmir2" value="<s:property value="microRNA_name"></s:property>"></td>
<td><s:property value="microRNA_name"></s:property></td>

<s:if test="#sz.Index=#sz.Index+7">
