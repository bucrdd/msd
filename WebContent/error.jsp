...
<p style="TABLE-LAYOUT: fixed;text-align:left; WORD-BREAK: break-all;font-family:'Calibri'; font-size:24.0000pt; font-weight:normal; "><B>The error comes from:</B></p>
<p style="TABLE-LAYOUT: fixed;text-align:left; WORD-BREAK: break-all;font-family:'Calibri'; font-size:22.0000pt; font-weight:normal; ">
1. There is a blank value in the histone modification column or the sample type column.</b></p>
<p style="TABLE-LAYOUT: fixed;text-align:left; WORD-BREAK: break-all;font-family:'Calibri'; font-size:22.0000pt; font-weight:normal; ">
2. Gene and Chromosome cannot be empty at the same time.</p>
<p style="TABLE-LAYOUT: fixed;text-align:left; WORD-BREAK: break-all;font-family:'Calibri'; font-size:22.0000pt; font-weight:normal; ">
3. There is no information about.</p>
  </div>
