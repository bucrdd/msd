  ...
  <div
    ...
    <div style="width:90%;margin:auto;">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="font-size:50px;" height="50" align="center" valign="top"><font color="#006192"><b>Advance
            Search</b></font></td>
        </tr>
      </table>
      ...
      <table cellspacing="13" align="center" width="1600" border="0" cellpadding="0">
        ...
        <tr>
          <td style="font-size:35px;" height="35" valign="middle" class="p2">
            <font face="Calibri" align="left" color="#006192"><b>Hismodifications</b></font>
          </td>
        ...
        <tr>
          <td style="font-size:35px;" align="left" height="35" valign="middle" class="p2">
            <font color="#006192">
              <nobr><b>Diseases/Cell types/Tissues</b></nobr>
            </font>
          </td>
          <td align="left" height="35"><label for="disease"></label>
            ...
            <font color="#006192" size="3">Example: medulloblastoma/uterus/K562</font>
          </td>
        </tr>
        <tr>
          <td height="10"></td>
        ...
        <tr>
          ...
          <td align="left"><label for="gtgene"></label>
            <input type="text" name="gtgene2" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>
            <font size="3" color="#006192">Example: SOX2</font>
          </td>
        </tr>
        <tr>
          <td height="10"></td>
        ...
        <tr>
          <td style="font-size:35px;" height="35" valign="middle" class="p2">
            <font face="Calibri" align="center" color="#006192"><b>GO ID</b></font></td>
          <td align="left"><label for="gtgene"></label>
            <input type="text" name="go" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>
            <font color="#006192" size="3">eg: GO:0004409</font>
          </td>
        </tr>
        <tr>
          <td height="10"></td>
        ...
        <tr>
          <td style="font-size:35px;" height="35" valign="middle" class="p2">
            <font face="Calibri" align="center" color="#006192">
              <b>KEGG ID</b>
            </font>
          </td>
          <td align="left"><label for="gtgene"></label>
            <input type="text" name="kegg" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>&nbsp
            <font color="#006192" size="3">eg: hsa00030</font></td>
        </tr>
        <tr>
          <td height="10"></td>
        </tr>
        ...
        <tr>
          <td></td>
          <td align="left">
            <input type="submit" class="button blue medium" name="button" id="button" value="Submit"
