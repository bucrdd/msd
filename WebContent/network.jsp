...
<div style="margin:0 auto;width:1970px;height:135px;z-index:1;">
  <a href="home.jsp">
    <img src="images/HHMD8.png" style="height: 190px; width: 1970px"/>
  </a>
</div>
<!-- 导航栏 -->
...
<div style="margin:0 auto;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;width:1970px;height:820px;z-index:3;background:#FFFFFF;position:relative;">
  <div style="font-size:18px; width:95%;margin:0 auto">
    ...
    <p align="left">
      <font color="#006192">
      HM_Gene_net can obtain the Gene-Histone Modifications network based Data stored in the database.Please enter the gene name in the search box below.
      </font>
    </p>
    <p>&nbsp;</p>
    <form id="form1" name="form1" method="post" action="quick.action" theme="simple" target="net">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr><td align="left"><font color="#006192"><b>Species</b></font></td></tr>
        <tr><td height="10"></td></tr>
        <tr>
          <td align="left" width="5%"><input type="radio" id="disease" name="diff_method" value="Disease" checked/><font color="#535457">&nbsp;Disease </font></td>
          <td align="left" width="5%"><input type="radio" id="normal" name="diff_method" value="Normal"/><font color="#535457">&nbsp;Normal</font></td>
          <td align="left" width="5%"><input type="radio" id="cellline" name="diff_method" value="CellLine"/><font color="#535457">&nbsp;Cell Line</font></td>
        </tr>
      </table>
      <p>&nbsp;</p>
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          ...
          <td width="30%" align="left"><label for="gtgene"></label><input type="text" name="query" id="query"/></td>
          <td align="left"><input type="submit" class="button blue medium" name="button" id="button" value="Submit"/></td>
        </tr>
        <tr>
          <td></td>
          <td style="font-size:17px;" align="left"><font color="#006192">Example: SOX2</font></td>
        </tr>
      </table>
    </form>
    <iframe height="600px" name="net" src="quick.jsp" scrolling="auto" frameborder="0" width="100%"></iframe>
  </div>
</div>
<p>&nbsp;</p>
...
<script type="text/javascript">
  $(function () {
    console.log("ready", document.form1.normal);
    document.form1.normal.checked = "checked";
    document.form1.query.value = "SOX2";
    $("#form1").submit();
    console.log("ready");
  });
