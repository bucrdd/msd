...
<div style="margin:0 auto;width:1970px;height:135px;z-index:1;">
  <a href="home.jsp"><img src="images/HHMD8.png" style="height: 190px; width: 1970px" alt="HHMD8"/></a>
</div>
<!-- 导航栏 -->
<jsp:include page="base/navigation.jsp"/>
        ...
        <div style="font-size:18px;width:770px;height:40px;line-height:20px;padding-left:0px; background:#006192;">
          <ul id="breadcrum">
            <li id="one1" onclick="setTab('one',1,4)" class="hover">
              <a><span class="icon icon-double-angle-right"> </span><b>Flow Chart</b></a></li>
            <li id="one2" style="margin-left:2px;" onclick="setTab('one',2,4)">
              <a><span class="icon icon-double-angle-right"></span><b>Introduction</b></a></li>
            <li id="one3" onclick="setTab('one',3,4)">
              <a><span class="icon icon-double-angle-right"></span><b>Histone modification</b></a></li>
            <li id="one4" onclick="setTab('one',4,4)">
              <a><span class="icon icon-double-angle-right"> </span><b>Highlight</b></a></li>
          </ul>
        </div>
      </div>
      <div class="row-fluid" style="width:600px;">
        <div class="span6"
             style="font-size:25px;line-height:28px;display:block;float:left;background:#FFFFFF;width:750px;padding-left:30px;padding-top:10px;text-align:justify; text-justify:inter-ideograph;">
          <div COLOR="#535457">
            <div class="widget-box">
              <div class="Contentbox" style="text-indent: 2em">
                <div id="con_one_1" class="widget-content hover">
                  ...
                  <p>SEA version 3.0 (i) stores the newly predicted super-enhancers and enhancers of
                    11 species based on a more optimized rules, expands the types of
                    Cell/Tissue/Disease from 134 to 246,
                    extends the SEs ranking factors from 1 to 3 and the number of species would be
                    increased when the needed data emerge; (ii) includes experimentally identified
                    and confirmed super-enhancers;
                    (iii) lists the functional compositional organization for each SEs through Hi-C
                    data based peak calling; (iv) provides the cell-type/tissue/disease specificity
                    of super-enhancer with an quantitative entropy value;
                    (v) includes online regulatory network supporting flexible analysis of the
                    relationships among coding / non-coding genes and super-enhancer; (vi)
                    supplements classification of publications related to
                    super-enhancers which should be useful for biologist following advance of
                    super-enhancer research; (vii) updated the visualization tool “Browser View of
                    Super-Enhancers”, which is
                    contained of abundant annotation tracks with supporting customized views in
                    genomic scale; (viii) integrates
                    <a target="_blank" class="linkA" href="http://amp.pharm.mssm.edu/Enrichr/">Enrichr</a>
                    into SEA version 3.0 to process the functional significance analysis of these
                    super enhancers.</p>
                ...
                <div id="con_one_2" class="widget-content" style="display:none">
                  <p>
                    ...
                    chromatin remodeling, gene transcriptional regula tion, stem cell maintenance
                    and differentiation.
                    Alterations in histone modifications may be linked to human diseases especially
                    cancer. Mining and integration of histone modification data can be beneficial to
                    novel biological discoveries.
                    Human Histone Modification Database focuses on the storage and integration of
                    histone modification datasets that were obtained from laboratory experiments.
                    To the best of our knowledge, there has been no special ized database that
                    focuses on histone modifications in mammals, which hinders further systematic
                    and in-depth data mining. </p>
                </div>
                <div id="con_one_3" class="widget-content" style="display:none">
                  <p align="left">Histone modification refers to the
                    process of histone N-terminal tail methylation,
                    acetylation, phosphorylation, adenosylation, ubiquitination and ADP ribosylation
                    under
                    the action of related enzymes. By wrapping DNA around core histones (H2A, H2B,
                    H3 and H4),
                    eukaryotic DNA is packaged into chromatin to form repetitive nucleosomes. In
                    mammalian cells.
                    Histone modification provides accessible targets for effectors such as histone
                    methyltransferase
                    and acetyltransferase, and has different effects on chromatin structure and gene
                    transcription
                    according to the type and location of modification. At present, we mainly study
                    the methyl,
                    acetyl and ubiquitin groups in various modification types through chip based
                    technology. </p>
                </div>
                <div id="con_one_4" class="widget-content" style="display:none">
                  <p>The new version of HHMD v 2.0 also increases the
                    number of histone modifications detected by ChIP-seq to 60, the number of
                    tissues/cells to 207, and 351 disease states (disease tissue 23, cell line
                    328).</p>
                  <p>HHMD v 2.0 screens out the characteristics of
                    differential histone modifications in tissues for 25 diseases.Based on the above
                    data, we respectively drew the network of histone modification-gene-disease/cell
                    line/normal tissue to visually show the relationship between histone
                    modification and sample type. </p>
                  <p>Aiming at the characteristics of histone
                    modifications identified in disease tissues/cell lines, combined with the drug
                    target database,a histone modification-gene target network was also
                    constructed.In addition, in order to facilitate the analysis of the regulatory
                    functions of histone modifications, HHMD v 2.0 provides a genome visualization
                    function, which comprehensively displays histone modifications, transcription
                    factor target genes, super enhancers, CpG islands, gene mutations, and also adds
                    some Hi-C,Spatial genome data of ATAC-seq.</p>
                </div>
              </div>
            </div>
          </div>
  ...
  <div style="margin-left:10px;width:450px; height:760px;float:left;position:relative;">
    <div style="margin-left:15px;margin-top:20px;display:block;float:left;width:600px;height:380px;background:#FFFFFF;border:3px solid #006192">
      <div style="width:597px;height:40px;line-height:40px;padding-left:30px;background:#006192;">
        <font size="5" style="float: center;" COLOR="#FFFFFF" face="Calibri"><b>Types in histone
          modifications</b></font>
      </div>
    ...
    <div style="margin-left:15px;margin-top:20px;display:block;float:left;width:600px;height:380px;background:#FFFFFF;border:3px solid #006192">
      <div style="width:596px;height:40px;line-height:40px;padding-left:30px;background:#006192;">
        <font size="5" style="float:center;" COLOR="#FFFFFF" face="Calibri"><b>Histone Modifications on human
          Chromsomes </b></font>
      </div>
      <td rowspan="5" valign="top"
          style="PADDING-BOTTOM: 5px; PADDING-LEFT: 50px; PADDING-RIGHT: 10px; PADDING-TOP: 5px">
  ...
  <div style="width:450px; height:780px;float:right;position:relative;">
    <div style="margin-right:10px;margin-top:20px;display:block;float:right;width:550px;height:780px;background:#FFFFFF;border:3px solid #006192;">
      <div style="width:547px;height:40px;line-height:40px;padding-left:30px;background:#006192;">
        <font size="5" style="float: center;" COLOR="#FFFFFF" face="Calibri"><b>Histone modifications in
          types</b></font>
      </div>
      <div id="container" style="min-width:530px;height:700px">
        <iframe height="700px" name="m6aprotein" src="bingtu.jsp" scrolling="auto" frameborder="0"
                width="100%"></iframe>
      </div>
    </div>
...
&nbsp;<div style="font-size:25px;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;margin-top:10px; margin:0 auto;width:1970px;height:75px;
  ...
  <p><font COLOR="#191970" face="Calibri"><b>2021 © School of Life Science and Technology, Computational Biology
    Research Center | Harbin, 150001, Heilongjiang,P.R. China </b></font>
    <script type="text/javascript"
            src="//rc.revolvermaps.com/0/0/3.js?i=2hqstc5qj5p&amp;b=0&amp;s=40&amp;m=5&amp;cl=ffffff&amp;co=010020&amp;cd=aa0000&amp;v0=60&amp;v1=60&amp;r=1"
            async="async"></script>
  </p>
