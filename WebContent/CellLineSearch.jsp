...
<tr><td style="font-size:50px;" height="50" align="center" valign="top"><font color="#006192" ><b>CellLine Search</b></font></td></tr>

</table>
<s:form id="Form2_1" name="Form2_1" action="gtgene5" method="post" theme="simple">
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
      ...
      <tr><td height="80"></td></tr>
        <tr>
          ...
          <td  align="left" height="45"><label for="disease"></label>
            ...
            value ="H3K4me1"><font size="30">H3K4me1</font></option>
...
<option>H2aK119ub</option>
      ...
      <tr>
          <td style="font-size:35px;"align="left" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cell types</b></font></td>
            <td align="left" height="35"><label for="disease"></label>
            <input type="text" name="type" id="disease" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;<font color="#006192" size="3">Example:K562</font></td>
        ...
        <tr>
          ...
          <td align="left" ><label for="gtgene"></label>
            <input type="text" name="gtgene5" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;<font color="#006192" size="3">Example: SOX2</font>
            </td>
        </tr>
         <tr><td height="10"></td></tr>
          <tr>
