...
<td><a href="ATAC?atactype=<s:property value="type"/>&atacchr=<s:property value="chr"/>&atacstart=<s:property value="start"/>&atacend=<s:property value="end"/>" target="_blank">ATAC</a></td>
<td><a href="HIC?hictype=<s:property value="type"/>&hicchr=<s:property value="chr"/>&hicstart=<s:property value="start"/>&hicend=<s:property value="end"/>" target="_blank">HIC</a></td>
...
<a href=\"gene?gene=ADAM19\" target=\"browse_right\">ADAM19</a>
