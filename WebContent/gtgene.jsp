...
<div id="apDiv7">
<s:form id="Form3_1" name="Form3_1" action="gtgene2" method="post" theme="simple">
...
<input name="gtgene2" type="checkbox" id="chkall"  onclick="CheckAll(this.form)"></input>
      select all
...
<tbody>
<s:iterator value="#request.gtgene_List">
<tr>

<td><input type="checkbox" name="gtgene2" value="<s:property value="gene"></s:property>"></input></td>
