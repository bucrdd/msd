...
<div id="apDiv7" >
<s:form id="Form3_1" name="Form3_1" action="gtsnp2" method="post" theme="simple">
...
<input type="submit" name="Submit" value="Search selected gene(s)"/>
<input name="gtsnp2" type="checkbox" id="chkall"  onclick="CheckAll(this.form)" />
      select all
...
<tbody>
<s:iterator value="#request.gtsnp_List">
<tr>

<td><input type="checkbox" name="gtsnp2" value="<s:property value="SNP_ID"></s:property>"></input></td>
<td><s:property value="SNP_ID"></s:property></td>
