...
<div  >
<s:form id="Form3_1" name="Form3_1" action="mirmir2" method="post" theme="simple">
...
<input name="mirmir2" type="checkbox" id="chkall"  onclick="CheckAll(this.form)" />
      select all
...
<tbody>
<s:iterator value="#request.mirmir_List">
<tr>

<td><input type="checkbox" name="mirmir2" value="<s:property value="microRNA_name"></s:property>"/></td>
