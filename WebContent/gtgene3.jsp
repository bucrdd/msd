...
<head>
  ...
  <script type="text/javascript" lang="javascript" src="js/jquery.dataTables.js"></script>
  <script type="text/javascript" lang="javascript" src="js/dataTables.buttons.min.js"></script>
  <script type="text/javascript" lang="javascript" src="js/jszip.min.js"></script>
  <script type="text/javascript" lang="javascript" src="js/pdfmake.min.js"></script>
  <script type="text/javascript" lang="javascript" src="js/vfs_fonts.js"></script>
  <script type="text/javascript" lang="javascript" src="js/buttons.html5.min.js"></script>
</head>
<body>
...
<div class="top" style="font-size:25px;margin:0 auto;margin-top:20px;width:1900px;height:45px;z-index: 99999;position: relative">
  ...
  <ul id="breadcrumb">
    ...
    <li><a href="Difftools.jsp"><span class="icon icon-gear"> </span>&nbsp; DiffTools</a></li>
    <li><a href="network.jsp"><span class="icon icon-rocket"> </span>&nbsp; HM_Gene_Net</a></li>
...
<div style="margin:0 auto;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;width:1970px;height:820px;z-index:3;background:#FFFFFF;position:relative;">
  ...
  <div style="width:95%;margin:auto">
    ...
    <table id="example" class="display" cellspacing="0">
      ...
      <tbody>
      <s:iterator value="#request.gtgene3_total">
        <tr>
          <td><s:property value="type"/></td>
          <td><s:property value="chr"/></td>
          <td><s:property value="start"/></td>
          <td><s:property value="end"/></td>
          <td><s:property value="genename"/></td>
          <td><s:property value="tdrug"/></td>
          <td><s:property value="tf"/></td>
          <td><s:property value="hm"/></td>
          <td>
            <a href="https://www.ncbi.nlm.nih.gov/geo/query/acc.cgi?acc=<s:property value="gse"/>" target="_blank"><s:property value="gse"/></a>
          </td>
          <td>
            <a href="ATAC?atactype=<s:property value="type"/>&atacchr=<s:property value="chr"/>&atacstart=<s:property value="start"/>&atacend=<s:property value="end"/>" target="_blank">ATAC</a>
          </td>
          <td>
            <a href="HIC?hictype=<s:property value="type"/>&hicchr=<s:property value="chr"/>&hicstart=<s:property value="start"/>&hicend=<s:property value="end"/>" target="_blank">HIC</a>
          </td>
          <td>
            <a href="http://genome.ucsc.edu/cgi-bin/hgTracks?org=human&db=hg38&position=<s:property value="chr"/>:<s:property value="start"/>-<s:property value="end"/>" target="_blank">UCSC</a>
          </td>
        </tr>
      </s:iterator>
      </tbody>
...
<p>&nbsp;</p>
<div style="font-size:25px;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;margin:0 auto;width:1970px;height:65px; z-index:1;">
  <p>&ensp;</p>
  <span style="color: #191970; font-family: Calibri, serif;"><b>2021 © School of Life Science and Technology, Computational Biology ResearchCenter | Harbin, 150001, Heilongjiang,P.R. China </b> </span>
</div>
<p>&nbsp;</p>
</body>
<script>
