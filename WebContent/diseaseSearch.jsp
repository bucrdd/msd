      ...
      <table cellspacing="13" align="left" width="1600" border="0" cellpadding="0">
        ...
        <tr>
          <td style="font-size:35px;" height="35" valign="middle" class="p2">
            <span face="Calibri" align="center" color="#006192"><nobr><b>Histone modification</b></nobr></span>
          </td>
        ...
        <tr><td style="font-size:35px;" align="left" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Diseases</b></font></td>
          <td align="left" height="35">
            <label for="disease"></label>
            <input type="text" name="type" id="disease" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;
            <span color="#006192" size="3">Example: medulloblastoma</span>
          </td>
        </tr>
        <tr><td height="10"></td></tr>
        <tr>
          <td style="font-size:35px;" align="left" width="12%" height="35" valign="middle" class="p2">
            <span color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gene</b></span>
          </td>
          <td align="left">
            <label for="gtgene"></label>
            <input type="text" name="gtgene3" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;
            <span color="#006192" size="3">Example: SOX2</span>
          </td>
        </tr>
        ...
        <tr>
          ...
          <td align="left" height="40px"><label for="protein"></label>
            <select name="chr" id="organ" style="width:300px; height:40px;font-size:24px;">
              <option value=""><span color="#006192"><b>Chromosome</b></span></option>
              <option>chr1</option>
              <option>chr2</option>
              <option>chr3</option>
              <option>chr4</option>
            ...
            <b>:</b>
            <input type="text" class="span3" placeholder="Start" name="start" id="protein" style="width: 300px; height:41px;font-size:24px;"/>
            <b>--</b>
            <input type="text" class="span3" placeholder="End" name="end" id="protein" style="width:300px;height: 41px;font-size:24px;"/>
      ...
      <table cellspacing="13" align="left" width="1600" border="0" cellpadding="0">
        ...
        <tr>
          <td style="font-size:35px;" align="left" height="35" valign="middle" class="p2">
            <font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cancer Name</b></font></td>
          <td align="left" height="35">
            <label for="disease"></label>
...
<div style="font-size:25px;margin-top:20px;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;margin-top:10px; margin:0 auto;width:1970px;height:65px;
	z-index:1;">
  <p>&ensp;</p>
  <span COLOR="#191970" face="Calibri"><b>2021 © School of Life Science and Technology, Computational Biology Research Center | Harbin, 150001, Heilongjiang,P.R. China </b> </span>
</div>
<p>&nbsp;</p>
</body>
