...
<p>&nbsp;</p>
<p>&nbsp;</p>
<div  style="margin:0 auto;-moz-box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF; -webkit-box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF; box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF;width:1800px;height:750px;z-index:3;background:#FFFFFF;"  ><div style="width:90%;margin:auto">
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
<tr><td height="30"></td></tr>
<tr><td style="font-size:50px;" height="50" align="center" valign="top"><font color="#006192" ><b>Disease Search</b></font></td></tr>
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
      ...
      <tr><td height="80"></td></tr>
        <tr>
          <td  style="font-size:35px;"height="35" valign="middle" class="p2"><font face="Calibri" align="center" color="#006192"><nobr><b>Histone modification</b></font></td>
...
<option>H2aK119ub</option>
      ...
      <tr>
          <td style="font-size:35px;"align="left" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Diseases</b></font></td>
           <td align="left" height="35"><label for="disease"></label>
            <input type="text" name="type" id="disease" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;<font color="#006192" size="3">Example:medulloblastoma</font></td> 
        </tr>
         <tr><td height="10"></td></tr>
        <tr>
          <td style="font-size:35px;"align="left" width="12%" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gene</b></font></td>
          <td align="left" ><label for="gtgene"></label>
            <input type="text" name="gtgene4" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;<font  color="#006192" size="3">Example: SOX2</font>
            </td>
        </tr>
          <tr><td height="25"></td></tr>
          <tr >
          <td  width="10000" style="font-size:35px;"align="left" height="35" valign="middle" class="p2"><font color="#006192"><nobr><b>Genome location</b></nobr></font></td>
...
<option>chrM</option>		
			 ...
			 <b>:</b> <input type="text" class="span3" placeholder="Start" name="start" id="protein" style="width: 300px; height:41px;font-size:24px;"/> <b>--</b> <input type="text" class="span3" placeholder="End" name="end" id="protein" style="width:300px;height: 41px;font-size:24px;"/>
      ...
      <tr><td height="10"></td></tr>
        <tr>
  <td >&nbsp;</td>
 <td   align="left"><input type="submit" class="button blue medium" name="button" id="button" value="Submit" style="width: 110px; height:50px;font-size:20px;" />
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
<tr><td height="30"></td></tr>
<tr><td style="font-size:50px;" height="50" align="center" valign="top"><font color="#006192" ><b>Cancer Search</b></font></td></tr>
...
<table width="100%" border="0"  cellspacing="0" cellpadding="0">
      ...
      <tr><td height="80"></td></tr>
		...
		<option value="H4R3me2">H4R3me2</option></select>
            </td>
            
        </tr>
         <tr><td height="10"></td></tr>
      <tr>
          <td style="font-size:35px;"align="left" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Cancer Name</b></font></td>
           <td align="left" height="35"><label for="disease"></label>
...
<tr><td height="10"></td></tr>
        <tr>
          <td style="font-size:35px;"align="left" width="12%" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;RefSeq ID</b></font></td>
          <td align="left" ><label for="gtgene"></label>
            <input type="text" name="Refseqid" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;<font  color="#006192" size="3">Example:NM_023936</font>
            </td>
        </tr>
        <tr><td height="10"></td></tr>
        <tr>
          <td style="font-size:35px;"align="left" width="12%" height="35" valign="middle" class="p2"><font color="#006192"><b>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Gene</b></font></td>
          <td align="left" ><label for="gtgene"></label>
            <input type="text" name="gene" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>&nbsp;<font  color="#006192" size="3">Example: MGMT</font>
            </td>
        </tr>
          <tr><td height="25"></td></tr>
          <tr >
