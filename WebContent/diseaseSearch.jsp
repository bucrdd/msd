...
<head>
  ...
  <script type="text/javascript">
    $(function () {
      ...
      }).data('checked', jRadio.get(0).checked);
    });
    $(function () {
      let j1Radio = $('#J1_radio');
      j1Radio.on('click', function () {
        let isChecked = $(this).data('checked');
        if (!isChecked && this.checked) {
          $(this).data('checked', true);
        } else {
        ...
        console.log($(this).data('checked'))
      }).data('checked', j1Radio.get(0).checked);
    });
    $(function () {
      let j2Radio = $('#J2_radio');
      j2Radio.on('click', function () {
        let isChecked = $(this).data('checked');
        if (!isChecked && this.checked) {
          $(this).data('checked', true);
        } else {
        ...
        console.log($(this).data('checked'))
      }).data('checked', j2Radio.get(0).checked);
    });
    $(function () {
      let j3Radio = $('#J3_radio');
      j3Radio.on('click', function () {
        let isChecked = $(this).data('checked');
        if (!isChecked && this.checked) {
          $(this).data('checked', true);
        } else {
        ...
        console.log($(this).data('checked'))
      }).data('checked', j3Radio.get(0).checked);
    });
    $(function () {
      let j4Radio = $('#J4_radio');
      j4Radio.on('click', function () {
        let isChecked = $(this).data('checked');
        if (!isChecked && this.checked) {
          $(this).data('checked', true);
        } else {
        ...
        console.log($(this).data('checked'))
      }).data('checked', j4Radio.get(0).checked);
    });
  </script>
  <style type="text/css">
    select#organ {
...
<div style="margin:0 auto;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;width:1970px;height:1570px;z-index:3;background:#FFFFFF;position:relative;">
  <p>&nbsp;</p>
  <p>&nbsp;</p>
  <div style="margin:0 auto;-moz-box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF; -webkit-box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF; box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF;width:1800px;height:750px;z-index:3;background:#FFFFFF;">
    <div style="width:90%;margin:auto">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <tr>
          <td style="font-size:50px;" height="50" align="center" valign="top">
            <font color="#006192"><b>Disease Search</b></font>
          </td>
        </tr>
      </table>
      <s:form id="Form2_1" name="Form2_1" action="gtgene3" method="post" theme="simple">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
        ...
        <table cellspacing="13" align="left" width="1600" border="0" cellpadding="0">
          <tr>
            <td style="font-size:35px;" height="35" valign="middle" class="p2">
              <font face="Calibri" align="center" color="#006192"><nobr><b>Histone modification</b></nobr></font>
            </td>
            <td align="left" height="45"><label for="disease">
          ...
          <tr>
            <td style="font-size:35px;" align="left" height="35" valign="middle" class="p2">
              <font color="#006192"><b>Diseases</b></font>
            </td>
            <td align="left" height="35"><label for="disease"></label>
              <input type="text" name="type" id="disease" style="width: 300px; height:41px;font-size:24px;"/>
              <font color="#006192" size="3">Example: medulloblastoma</font>
            </td>
          </tr>
          <tr>
            <td style="font-size:35px;" align="left" width="12%" height="35" valign="middle" class="p2"><font
                color="#006192"><b>Gene</b></font>
            </td>
            <td align="left"><label for="gtgene"></label>
              <input type="text" name="gtgene3" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>
              <font color="#006192" size="3">Example: SOX2</font>
            </td>
          </tr>
          <tr>
            <td width="10000" style="font-size:35px;" align="left" height="35" valign="middle" class="p2">
              <font color="#006192"><nobr><b>Genome location</b></nobr></font>
            </td>
            <td align="left" height="40px">
              ...
              <b>:</b>
              <input type="text" class="span3" placeholder="Start" name="start" id="protein"
                     style="width: 300px; height:41px;font-size:24px;"/>
              <b>--</b>
              <input type="text" class="span3" placeholder="End" name="end" id="protein"
                     style="width:300px;height: 41px;font-size:24px;"/>
              <!--<input type="text" name="drug" id="protein" /></td> -->
          </tr>
          <tr>
            <td>&nbsp;</td>
            <td align="left"><input type="submit" class="button blue medium" name="button" id="button"
                                    value="Submit" style="width: 110px; height:50px;font-size:20px;"/>
  ...
  <div style="margin:0 auto;-moz-box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF; -webkit-box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF; box-shadow:1px 3px 20px #BFBFBF, 2px 2px 5px #BFBFBF;width:1800px;height:750px;z-index:3;background:#FFFFFF;">
    <div style="width:90%;margin:auto">
      <table width="100%" border="0" cellspacing="0" cellpadding="0">
        <tr>
          <td style="font-size:50px;" height="50" align="center" valign="top"><font color="#006192"><b>Cancer Search</b></font></td>
        </tr>
      </table>
      <s:form id="Form2_1" name="Form2_1" action="cancer" method="post" theme="simple">
        <table width="100%" border="0" cellspacing="0" cellpadding="0">
          <!--   <tr><td align="left"><font color="#006192">Species</font></td></tr><tr><td height="10"></td></tr>
           <tr>
           <td align="left" width="5%" ><input type="radio"  name="diff_method" value="R" checked/><font color="#535457">&nbsp;Disease</font></td>
        ...
        <table cellspacing="13" align="left" width="1600" border="0" cellpadding="0">
          <tr>
            <td style="font-size:35px;" height="35" valign="middle" class="p2">
              <font face="Calibri" align="center" color="#006192"><nobr><b>Histone modification</b></font>
            </td>
            <td align="left" height="45"><label for="disease"></label>
              <select height="45px" name="hm" id="organ" style="width:300px; height:40px;font-size:24px;">
                <option value="H3K4me1"><font size="30">H3K4me1</font></option>
                <option value="H2Bub1">H2BUb</option>
                <option value="H3K4me2">H3K4me2</option>
                <option value="H3me2">H3me2</option>
                <option value="H3me3">H3me3</option>
                <option value="H3R8me2">H3R8me2</option>
                <option value="H3K9me2">H3K9me2</option>
                <option value="H3K9me">H3K9me1</option>
                ...
                <option value="H4R3me2">H4R3me2</option>
              </select>
            </td>
          </tr>
          <tr>
            <td style="font-size:35px;" align="left" height="35" valign="middle" class="p2">
              <font color="#006192"><b>Cancer Name</b></font>
            </td>
            <td align="left" height="35"><label for="disease"></label>
              <select name="tissue" id="organ" style="width:300px; height:40px;font-size:23px;">
                <option value=""><font color="#006192"><b>Any</b></font></option>
                <option value="Colon">Colon</option>
                <option value="Lymphoma">Lymphoma</option>
                <option value="Leukemia">Leukemia</option>
                <option value="Gastric">stomach</option>
                <option value="Prostate">Prostate</option>
                <option value="Breast">Breast</option>
                <option value="Lung">Lung</option>
                <option value="Ovarian">Ovary</option>
                <option value="Pancreatic">Pancreas</option>
              </select>
          </tr>
          <tr>
            <td style="font-size:35px;" align="left" width="12%" height="35" valign="middle" class="p2">
              <font color="#006192"><b>RefSeq ID</b></font>
            </td>
            <td align="left"><label for="gtgene"></label>
              <input type="text" name="Refseqid" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>
              <font color="#006192" size="3">Example:NM_023936</font>
            </td>
          </tr>
          <tr>
            <td style="font-size:35px;" align="left" width="12%" height="35" valign="middle" class="p2">
              <font color="#006192"><b>Gene</b></font>
            </td>
            <td align="left"><label for="gtgene"></label>
              <input type="text" name="gene" id="gtgene" style="width: 300px; height:41px;font-size:24px;"/>
              <font color="#006192" size="3">Example: MGMT</font>
            </td>
          </tr>
          <tr>
            <td width="10000" style="font-size:35px;" align="left" height="35" valign="middle" class="p2">
            ...
            <td align="left" height="40px"><label for="protein"></label>
              <select name="Tech" id="organ" style="width:300px; height:40px;font-size:23px;">
                <option value=""><font color="#006192"><b>Any</b></font></option>
                <option value="ChIP-PCR">ChIP-PCR</option>
          ...
          <tr>
            <td></td>
            <td align="left">
              <input type="submit" class="button blue medium" name="button" id="button" value="Submit" style="width: 110px; height:50px;font-size:20px;"/>
              <input type="reset" class="button blue medium" name="button" id="button" value="Reset" style="width: 110px; height:50px; font-size:20px;"/>
            </td>
          </tr>
        </table>
      </s:form>
...
<div style="font-size:25px;margin-top:20px;-moz-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; -webkit-box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F; box-shadow:1px 3px 20px #003F5F, 2px 2px 5px #003F5F;margin-top:10px; margin:0 auto;width:1970px;height:65px; z-index:1;">
