...
<input name="mirgene2" type="checkbox" id="chkall"  onclick="CheckAll(this.form)" />
      select all
...
<tbody>
<s:iterator value="#request.mirgene_List">
<tr>

<td><input type="checkbox" name="mirgene2" value="<s:property value="gene"></s:property>" /></td>
