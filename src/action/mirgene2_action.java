...
public class mirgene2_action implements Action {
	...
	public String execute() throws Exception {
		...
		if(len!=2){
			...
			if(diseasetheName.get(0)==diseasetheName.get(1)){
				...
				this.fileName = diseasetheName.get(0) + "_vs_" + diseasetheName.get(1) + "_PePr.zip";
				getDownloadFile();
				return SUCCESS;
			}
		}else if(lenNN==2){
			if(normaltheName.get(0)==normaltheName.get(1)){
				...
				this.fileName = normaltheName.get(0) + "_vs_" + normaltheName.get(1) + "_PePr.zip";
				getDownloadFile();
				return SUCCESS;
			}
		}else if(lenDCDC==2){
			if(diseaseCelltheName.get(0)==diseaseCelltheName.get(1)){
				...
				this.fileName = diseaseCelltheName.get(0) + "_vs_" + diseaseCelltheName.get(1) + "_PePr.zip";
				getDownloadFile();
				return SUCCESS;
			}
		}else if(lenNCNC==2){
			if(normalCelltheName.get(0)==normalCelltheName.get(1)){
				...
				this.fileName = normalCelltheName.get(0) + "_vs_" + normalCelltheName.get(1) + "_PePr.zip";
				getDownloadFile();
				return SUCCESS;
			}
		}else if(lenDN==2){
				this.fileName = diseasetheName.get(0) + "_vs_" + normaltheName.get(0) + "_PePr.zip";
				getDownloadFile();
				return SUCCESS;
		}else if(lenDNC==2){
			this.fileName = diseasetheName.get(0) + "_vs_" + normalCelltheName.get(0) + "_PePr.zip";
			getDownloadFile();
			return SUCCESS;
		}else if(lenDDC==2){
			this.fileName = diseasetheName.get(0) + "_vs_" + diseaseCelltheName.get(0) + "_PePr.zip";
			getDownloadFile();
			return SUCCESS;
		}else if(lenNDC==2){
			this.fileName = normaltheName.get(0) + "_vs_" + diseaseCelltheName.get(0) + "_PePr.zip";
			getDownloadFile();
			return SUCCESS;
		}else if(lenNNC==2){
			this.fileName = normaltheName.get(0) + "_vs_" + normalCelltheName.get(0) + "_PePr.zip";
			getDownloadFile();
			return SUCCESS;
		}else if(lenNCDC==2){
			this.fileName = diseaseCelltheName.get(0) + "_vs_" + normalCelltheName.get(0) + "_PePr.zip";
			getDownloadFile();
			return SUCCESS;
		}else{
			return ERROR;
	...
	public InputStream getDownloadFile() throws Exception {
		String filenamePath = "/download/PePr/" + fileName;
