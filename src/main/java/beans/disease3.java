...
public class disease3 {
	...
	public disease3( String disease, String name ,String chr ,String start,String end,String strand,String logFC ,String pvalue, String diff_method,String gse, String Treat_method){
	super();
	this.disease = disease;
	this.name = name;
	this.chr =  chr;
