...
public class XmlWriter implements SVGConstants {
    ...
    public static void writeSvg(Document document,File file) throws IOException{
        ...
        XmlWriter.writeXml(svgDocument, fw, false);
        fw.flush();
        fw.close();
    }
    
    public static void writePng(File svgfile,File pngFile) throws TranscoderException, IOException{
    	 PNGTranscoder transcoder = new PNGTranscoder();
		 InputStream instream =new FileInputStream(svgfile);
