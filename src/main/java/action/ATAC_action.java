...
public class ATAC_action implements Action {
  ...
  public String execute() throws Exception {
    ...
    String sql =
        "select * from " + table + " where chr='" + atacchr + "' and ((start <= '" + atacstart + "' and end >= '"
            + atacend + "') or " + " (start <= '" + atacstart + "' and end <= '" + atacend + "') or " + " (start >= '"
            + atacstart + "' and end <= '" + atacend + "') or " + " (start >= '" + atacstart + "' and end >= '"
            + atacend + "')) ";
